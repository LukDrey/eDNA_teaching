...
```{r, eval = F}
# Read in the table from the floristic study. 
floristic <- utils::read.csv('WiGa_Pilze_Master_20220525_MMM.csv', sep = ',')

# Keep only the columns of the dataframe we want to keep and change their names to english. 
...
makeblastdb -in file -parse_seqids -dbtype nucl -out blastdb

# Compare the sequences to each other and create a match list of sequences that are similar to each other.
blastn -db blast_db \

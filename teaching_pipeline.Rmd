...
```{bash}
# Combine he consensus sequences into one big fasta file
cat *.fasta > full_consensus.fasta

# Make a searchable BLAST database out of the UNITE general .fasta release. 
makeblastdb -in test.fasta -title "unite_db" -parse_seqids -dbtype nucl -out unite_db

# Match the consensus sequences to the UNITE database 
blastn -query full_consensus.fasta \
-strand both \
-task megablast \
